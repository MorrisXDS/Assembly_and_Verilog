...
KEY_0:          
                LDR       R2, [R5]         //toggle the value of RUN
                CMP       R2, #1
                BEQ     SET_ZERO
                MOV       R2, #1
                STR       R2, [R5]
...
KEY_1:                    
                LDR       R4, =0xFFFEC600   //set the timer to 2x speed
                LDR       R5, =0b110
                STR       R5, [R4,#0x8]
                LDR       R2, [R4]
                LSL       R2, #1
...
KEY_2:          LDR       R4, =0xFFFEC600   //set the timer to 1/2 speed
                LDR       R5, =0b110
                STR       R5, [R4,#0x8]
                LDR       R2, [R4]
                LSR       R2, #1
...
KEY_3:          LDR       R4, =0xFFFEC600   //reset the timer back to 1x speed
                LDR       R5, =0b110
                STR       R5, [R4,#0x8]
                LDR       R2, =50000000
                STR       R2, [R4]
